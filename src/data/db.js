...
db.version(16).stores({
  ...
  labours: "++id,name,address,aadhaarNo,mobileNo",
});
...
db.version(17).stores({
  ...
  patternMaster: "++id,category,job,[category+job]",
});
...
db.version(18).stores({
  ...
  fabEntries:
    "++id,date,month,week,grinNo,rollNo,party,invoice,category,quality,meter,rate,value,average",
